...
// Define the type of the event object. This is just a simple example to show
// how to interact with the conversation context. In a real-world application,
// you would probably have a more complex object with more properties.

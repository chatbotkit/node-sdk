...
- [extend](integration_discord.DiscordIntegrationClient.md#extend)
...
▸ **extend**(`extensionOptions`): [`DiscordIntegrationClient`](integration_discord.DiscordIntegrationClient.md)

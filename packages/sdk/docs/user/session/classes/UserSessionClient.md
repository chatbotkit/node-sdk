...
[@chatbotkit/sdk](../../../modules.md) / [user/session](../README.md) / UserSessionClient

# Class: UserSessionClient

Defined in: [user/session/index.js:7](https://github.com/chatbotkit/node-sdk/blob/main/sdks/node/packages/sdk/src/user/session/index.js#L7)
...
> **new UserSessionClient**(`options`): `UserSessionClient`

Defined in: [user/session/index.js:11](https://github.com/chatbotkit/node-sdk/blob/main/sdks/node/packages/sdk/src/user/session/index.js#L11)
...
> **create**(`userId`, `request`): [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`UserSessionCreateResponseBody`](../v1/type-aliases/UserSessionCreateResponseBody.md)\>

Defined in: [user/session/index.js:22](https://github.com/chatbotkit/node-sdk/blob/main/sdks/node/packages/sdk/src/user/session/index.js#L22)
...
[`UserSessionCreateRequestBody`](../v1/type-aliases/UserSessionCreateRequestBody.md)

#### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<[`UserSessionCreateResponseBody`](../v1/type-aliases/UserSessionCreateResponseBody.md)\>

***

### extend()

> **extend**(`extensionOptions`): `UserSessionClient`

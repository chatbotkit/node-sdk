...
export class SitemapIntegrationClient extends ChatBotKitClient {
     ...
     */
    list(request?: import("./v1.js").SitemapIntegrationListRequest): ResponsePromise<import("./v1.js").SitemapIntegrationListResponse, import("./v1.js").SitemapIntegrationListStreamType>;
    /**

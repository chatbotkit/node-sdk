...
export type CbkAbilityName = 'abort'
  ...
  | 'blueprint/bulletin/create'
  | 'blueprint/bulletin/list'
...
export type AvatarUrlIntegrationByIdParameters = {
 /** The ID of the Avatar integration to use */
...
export interface CbkAbilityRegistry {
  ...
  'avatar/url[integration-by-id]': {
    ...
    description: 'Returns the hosted ChatBotKit avatar frame URL for the selected Avatar integration.'
    parameters: AvatarUrlIntegrationByIdParameters
  }
  'blueprint/bulletin/create': {
    name: 'Post Current Blueprint Bulletin'
    description: 'Post a message to the current blueprint shared board'
    parameters: BlueprintBulletinCreateParameters
  }
  'blueprint/bulletin/list': {
    name: 'List Current Blueprint Bulletins'
    description: 'List the bulletins on the current blueprint shared board'
    parameters: BlueprintBulletinListParameters
  }
  'blueprint/meta/fetch': {

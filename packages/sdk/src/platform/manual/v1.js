 ...
 *
 * @typedef {import('../../types/api/v1.js').operations['listPlatformContentManuals']['responses']['200']['content']['application/json']} PlatformManualListResponse
 *
 * @typedef {PlatformManualListResponse['items'][number]} PlatformManualListItem
 *
 * @typedef {import('../../types/api/v1.js').operations['listPlatformContentManuals']['responses']['200']['content']['application/jsonl']} PlatformManualListStreamType
 *
...
/**
 * @typedef {import('../../types/api/v1.js').operations['searchPlatformContentManuals']['requestBody']['content']['application/json']} PlatformManualSearchRequestBody
 *
 * @typedef {PlatformManualSearchRequestBody} PlatformManualSearchRequest
 *
 * @typedef {import('../../types/api/v1.js').operations['searchPlatformContentManuals']['responses']['200']['content']['application/json']} PlatformManualSearchResponseBody
 *
...
/**
 * @typedef {import('../../types/api/v1.js').operations['fetchPlatformContentManual']['responses']['200']['content']['application/json']} PlatformManualFetchResponse
 *
 * @param {ChatBotKitClient} client

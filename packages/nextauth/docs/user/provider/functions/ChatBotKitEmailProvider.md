...
[@chatbotkit/nextauth](../../../modules.md) / [user/provider](../README.md) / ChatBotKitEmailProvider

# Function: ChatBotKitEmailProvider()

> **ChatBotKitEmailProvider**(`options?`): `EmailConfig`

Defined in: user/provider.js:86
...
to work seamlessly with the ChatBotKit User API and provides a
...
for ChatBotKit users. This creates unnecessary complexity and
...
you rely solely on the users created within ChatBotKit. This
means:
...
- **Automatic user provisioning**: Users are automatically connected to their
...
ChatBotKit's User API as your complete user management and authentication
backend.
...
import { ChatBotKitEmailProvider } from '@chatbotkit/nextauth/user'

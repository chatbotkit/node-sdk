...
> **getTools**(`selectedTools?`): [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, \{ \}\>

Defined in: [sdks/node/packages/cli/src/tools.js:11](https://github.com/chatbotkit/cbk-platform/blob/main/sdks/node/packages/cli/src/tools.js#L11)

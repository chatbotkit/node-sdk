...
| Next.js            | [User NextAuth Example](https://github.com/chatbotkit/node-sdk/tree/main/examples/nextjs/pages/user-auth)                                                         | Shows how to provision isolated users through NextAuth.                                                                                                                                                                                                                                               |
...
- **Platform Documentation**: Comprehensive guide to the platform [here](https://docs.cbk.ai/node-sdk).
